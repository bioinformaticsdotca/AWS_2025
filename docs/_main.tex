...
Welcome to the AWS/Unix primer Canadian Bioinformatics Workshop webpage!

\section{Schedule}\label{schedule}

YOUR SCHEDULE HERE

\chapter{Logging into AWS}\label{logging-into-aws}

\chapter{Introduction to the command line}\label{introduction-to-the-command-line}

\chapter{File Manipulation}\label{file-manipulation}
